      ...
      >
        {profile?.avatar_url ? (
          <Image
            ...
            alt="프로필 이미지"
            fill // [⭐️ 수정] layout="fill" 대신 fill 사용
            className="object-cover rounded-full" // [⭐️ 수정] Image 컴포넌트에 rounded-full 직접 적용
            // [!] Supabase Storage 호스트네임을 next.config.ts에 추가해야 합니다.
            // 예: images: { remotePatterns: [{ protocol: "https", hostname: "drdoamgazuhwktmqfoxb.supabase.co" }] }
          />
        ) : (
