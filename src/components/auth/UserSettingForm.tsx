  ...
  return (
    <div className="min-h-screen flex items-center justify-center">
      <div className="relative z-10 w-full max-w-[600px]">
        <div className="bg-white/40 border border-white/20 rounded-xl p-6 shadow-xl dark:bg-white/20 dark:shadow-xl dark:shadow-white/20">
          ...
          <form action={formAction} className="space-y-5">
            ...
            <div className="text-center pt-3 mb-2">
              <span className="text-[12px] text-gray-400 leading-snug">
                ...
                <a
                  href="#"
                  className="text-purple-600 hover:text-purple-700 dark:text-purple-300 dark:hover:text-purple-400"
                >
                  이용 약관
                </a>
                {" 및 "}
